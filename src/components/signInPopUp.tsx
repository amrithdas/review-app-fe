    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
            <div className="relative bg-white p-8 rounded-lg shadow-lg w-96">
                ...
                <a href='' className='text-sm mt-4 text-center font-medium flex items-center   justify-center'>Already Sign-In? <span className='ml-2 text-cyan-500	'>Sign-Up</span></a>
